...
const YeuThichsp = () =>  {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4 pl-[410px] ">Danh sách yêu thích của bạn</h1>
            ...
            {hotels.map(hotel => (
              <div key={hotel.id} className="bg-white  rounded shadow">
                <div className="relative">
                  ...
                  >
                    <Heart className={`w-5 h-5 ${favoriteHotels.includes(hotel.id) ?  'text-gray-500':  'text-red-500 fill-current'}`} />
                  </button>
