    ...
    <>
      ...
      >
        <div className="text-center p-4 sm:p-8 md:p-20">
          <p className="text-[16px] sm:text-[18px] md:text-[20px] font-bold text-white">
            TẦM NHÌN
          </p>
          <h1 className="text-[28px] sm:text-[36px] md:text-[48px] font-bold text-white mt-2 mb-4">
            Tôn vinh vẻ đẹp Việt Nam
          </h1>
          <p className="text-[14px] sm:text-[16px] md:text-[20px] font-bold text-white">
            Trở thành một trong những thương hiệu dịch vụ khách sạn hàng đầu khu
            vực Đông Nam Á, nâng cao vị thế và hình ảnh của Việt Nam
          </p>
        </div>
        <div className="flex flex-wrap justify-center gap-3 text-center px-4">
