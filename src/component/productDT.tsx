  ...
  return (
    <>
      <div className="container">
        <div className="product flex justify-center gap-5">
          <div className="cntRight">
            ...
            <div className="relative">
              ...
              <img
                className="w-[884px] h-[592px] object-cover"
            ...
            {/* Thumbnails */}
            <div className="flex gap-[17px] mt-2">
              {images.map((image, index) => (
                <img
                  key={index}
                  className={`w-[163px] h-[109px] object-cover cursor-pointer ${
            ...
            <div className="des w-[858px] h-[198px] mt-6">
              <p className="text-[24px] font-bold">Mô tả</p>
              <span>
                Silk Path Grand Resort & Spa Sapa tọa lạc trên ngọn đồi riêng
                tuyệt đẹp với tầm nhìn ôm trọn dãy núi Hoàng Liên Sơn bao quanh
                là mây trắng bồng bềnh, cảm hứng từ những tòa lâu đài Pháp kiêu
                sa với 152 phòng ngủ và biệt thự sang trọng. Sở hữu vẻ đẹp tinh
                tế, quý phái theo phong cách kiến trúc Đông Dương đặc trưng thời
                Pháp thuộc cùng họa tiết trang trí đậm nét văn hóa Sapa bản địa,
                Silk Path Grand Resort & Spa Sapa tự hào là khu nghỉ dưỡng đậm
                chất châu Âu thơ mộng giữa núi rừng Tây Bắc...
              </span>
            </div>
          </div>
            ...
            <div className="p-4 bg-card rounded-lg shadow-md m-4">
              ...
              <div className="mt-4">
                <span className="text-lg font-bold">
                  Giá:{" "}
                  <span className="text-red-500 line-through">1.500.000Đ</span>{" "}
                  1.000.000Đ
                </span>
              </div>
              <div className="mt-4">
        ...
        <div className="option m-7">
          <div className="border rounded shadow-md w-[885px] h-[230px] mb-5">
            ...
            <div className="flex gap-8 mt-10 ml-[20px]">
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <div className="flex items-center mb-1">
                      ...
                      <span className="text-[#022747BD] text-[15px]">15m2</span>
                    </div>
                    <div className="flex items-center mb-1">
