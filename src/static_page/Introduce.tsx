    ...
    <div className="container mb-[100px] w-full">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4 text-xl">
          Trở thành một trong những thương hiệu khách sạn Việt Nam nổi bật nhất Đông 
          nam Á.
        </p>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-bold mb-2 pl-12">Mang lại trải nghiệm, hạnh phúc đến cho khách hàng, đối tác, 
          người lao động, chủ sở hữu và cộng đồng thông qua các sản 
          phẩm và dịch vụ khách sạn.</h2>
        <p className="my-10 text-xl">
        Với sứ mệnh cao cả, VGH Group đang từng bước đưa sứ mệnh này đi vào thực tiễn tại 
          thị trường sản Việt Nam, mang hình ảnh Việt Nam đến khắp năm châu thông 
          qua việc cung cấp trải nghiệm, sản phẩm, dịch vụ độc đáo, chưa từng có trí 
          cho khách hàng và các tương quan.
        </p>
